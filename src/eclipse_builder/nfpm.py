...
[Desktop Entry]
Name={desktop_name}
Exec=env GDK_BACKEND={desktop_gdk_backend} /usr/bin/{package_basename} {desktop_vm} {desktop_vm_args}
Type=Application
...
def build_package(content: str, spec: dict[str, str], workdir: pathlib.Path, rpm: bool, deb: bool):
    packages = []
